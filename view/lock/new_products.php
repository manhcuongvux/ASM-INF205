  ...
  <div class="product">
    <div class="product-inner">
      <div class="product-img">
        <div class="picture">
          ...
          <div class="img-overlay">
            ...
            <a class="btn more btn-primary" href="usercontroller.php?action=product-detail&proid=<?php echo $product['ProductID']; ?>&idbrand=<?php echo $product['IdBrand']; ?>&typeId=<?php echo $product['TypeId']; ?>">More</a>
      ...
      <div class="main-titles no-margin">
        <h4 class="title" style="text-align: center; color: red;"><?php echo $product['ProductPrice']; ?>đ</h4>
